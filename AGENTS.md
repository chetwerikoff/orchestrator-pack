...
| `adversarial-draft-review` | «с кодексом», «обсуди с кодексом», «посоветуйся с кодексом», «выясни с кодексом», «драфт с кодексом», «создай задачу с кодексом», «придирчиво», «оспорь подход»; “draft with codex”, “adversarial draft”, “challenge the approach” | standalone Codex loop only; no create-issue-draft role |
| `discuss-with-gpt` | «с gpt», «с гпт», «обсуди с gpt», «обсуди с гпт», «посоветуйся с gpt», «выясни с gpt», «драфт с gpt», «создай задачу с gpt»; “draft with gpt”, “discuss with gpt”, “challenge with gpt” | browser-GPT challenge, tracked turn mechanics, or Issue entry |
| `create-issue-draft` | authoring or accepting a new task spec; GPT task-chat + Issue handoff; or brief-only request | GPT-only fixed per-tier flow; flow-manager drives through acceptance; no tracked draft/index |
