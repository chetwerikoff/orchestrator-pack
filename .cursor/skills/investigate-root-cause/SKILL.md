...
Read and execute [`.claude/skills/investigate-root-cause/SKILL.md`](../../../.claude/skills/investigate-root-cause/SKILL.md) in full. Do not re-derive the workflow inline.
