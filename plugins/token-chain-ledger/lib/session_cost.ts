...
/** Explicit runtime session cost; accepts camelCase and ledger snake_case fields. */
...
/** Explicit runtime session information used for chain and cost attribution. */
...
/** Event kinds that may resolve explicit runtime-session or parsed stdout cost. */
