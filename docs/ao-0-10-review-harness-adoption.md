...
CI verifies the Node 20 adapter path, the full light-lane cutover contract, strict self-architect policy, and complete pack verification, including retirement of daemon reviewer-config writes.
