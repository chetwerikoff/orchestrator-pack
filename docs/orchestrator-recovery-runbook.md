...
`pwsh -NoProfile -File scripts/check-autonomous-capabilities.ps1 -ReviewStart` passes, and `scripts/autonomous-orchestrator-boundary.test.ts` covers the AO 0.10.2 role matrix. Audit rows live under
