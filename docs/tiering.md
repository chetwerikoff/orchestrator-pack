...
3. **Cut ALL overengineering — PRIMARY goal.** Re-evaluate every major mechanism
   ...
   mechanism is necessary. “Traces to a finding” alone is not a keep-justification.
   A lens verdict without this forced-cut answer and its resolution is invalid.
