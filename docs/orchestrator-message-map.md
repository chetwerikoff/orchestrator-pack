...
| review-findings-first-send | AO 0.10 auto-delivery on review submit (pack first-send reconcile REMOVED) | journaled-worker-send | specific-session | review-findings-first | ao-send | none |
| review-findings-redelivery | Bounded re-delivery when first send unconfirmed | journaled-worker-send | specific-session | review-findings-redelivery | ao-send | none |
