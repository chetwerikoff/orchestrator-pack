...
const SAFE_RULES: readonly SafeRule[] = [
  ...
  { pattern: '.claude/skills/create-issue-draft/**', required: ['generated-parity-only', 'review-source-cardinality-only'], allowed: ['generated-parity-only', 'review-source-cardinality-only'] },
  { pattern: '.claude/skills/discuss-with-gpt/**', required: ['generated-parity-only', 'review-source-cardinality-only'], allowed: ['generated-parity-only', 'review-source-cardinality-only'] },
  { pattern: '.cursor/skills/create-issue-draft/**', required: ['author-declaration-validation', 'review-source-cardinality-only'], allowed: ['author-declaration-validation', 'review-source-cardinality-only'] },
  { pattern: '.cursor/skills/discuss-with-gpt/**', required: ['review-source-cardinality-only'], allowed: ['review-source-cardinality-only'] },
