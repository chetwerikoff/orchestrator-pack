...
import { claimHelperPath, describe, evaluateOrchestratorTurnGate, expect, fakeGhPath, it, listShieldAuditRecords, mkdtempSync, path, psString, repoRoot, rmSync, runPwsh, runScopedPreflight, shieldHelperPath, stableHead, tmpdir, writeFileSync } from './_test-review-start-preflight-shield-heavy.shared.js';
    ...
    describe('AC8 audit head keying', () => {
      ...
      `);
                ...
                expect(audits
                    ...
                    .every((row) => row.headSha === stableHead)).toBe(true);
            }
            finally {
