...
import { activateCutover, productionActivationBoundary, type ActivationBoundary } from '../lib/cutover/activation-transaction.ts';
...
import { FOUNDATION_COMMIT, D928 } from '../pr2a/contracts.ts';
