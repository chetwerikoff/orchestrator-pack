...
export const PUBLICATION_STATES = [
  'committed_ok','not_committed','in_progress','recovery_required','conflict','profile_blocked',
  'profile_mismatch','driver_error',
] as const;

export type FailureScope = 'none'|'invocation'|'conversation'|'profile';
export type IncidentKind =
  | 'conversation_incident' | 'fresh_orphan' | 'profile_wall' | 'active_owner' | 'publication_incident';
