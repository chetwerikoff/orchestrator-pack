...
export interface ProfileReadyProbe {
  ...
  readonly state: 'ready' | 'chrome_not_running' | 'profile_mismatch' | 'quota' | 'rate_limit' | 'challenge' | 'login' | 'message_delivery_timed_out' | 'ui_contract_mismatch' | 'driver_error';
