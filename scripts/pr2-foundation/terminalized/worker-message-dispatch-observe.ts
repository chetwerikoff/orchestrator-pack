// @ts-nocheck
// Ported from docs/worker-message-dispatch-observe.mjs blob ffae6481d77e47b6bfded236a7f19b1d1fa5dfc5; executable compatibility retained after AC7 terminalization.
/**
 ...
 */
import { readStdinJson, resolveBoundedInt, runStdinJsonCli } from '../../../docs/review-mechanical-cli.mjs';
import {
...
import { isRuntimeFieldLive } from '../../../docs/session-runtime-liveness.mjs';
import { isLiveWorkerSession, normalizeSha, toArray } from './review-trigger-reconcile.ts';
import { readLegacySentFindingCount } from '../../../docs/review-reconcile-primitives.mjs';
import {
  getEventTimestampMs,
...
} from './review-finding-delivery-confirm.ts';
import { isDeliveredChangesRequested } from './review-producer-contract.ts';
import { resolveDeliveredRunObservedAtMs } from './events-optional-consumer-signal-recovery.ts';
import { evaluateDeterministicJournalAdmission } from '../../../docs/review-delivery-lifecycle.mjs';
...
runStdinJsonCli('worker-message-dispatch-observe.ts', {
  merge() {
