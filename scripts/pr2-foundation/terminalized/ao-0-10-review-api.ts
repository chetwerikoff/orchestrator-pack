// @ts-nocheck
// Ported from docs/ao-0-10-review-api.mjs blob fe5dbe230e413b1ce591dbf7dfde8bffbee51d16; executable compatibility retained after AC7 terminalization.
/**
...
import { readStdinJson, runStdinJsonCli, toArray } from '../../../docs/review-mechanical-cli.mjs';
import {
 ...
 * @returns {import('./review-producer-contract.ts').NormalizedReviewRun[]}
 */
...
runStdinJsonCli('ao-0-10-review-api.ts', {
  'flatten-runs': () => {
