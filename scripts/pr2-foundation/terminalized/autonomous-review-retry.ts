// @ts-nocheck
// Ported from docs/autonomous-review-retry.mjs blob aa92a6638acd33dab07e743868bedfcf51f347d5; executable compatibility retained after AC7 terminalization.
/**
...
} from './reviewer-failure-evidence-markers.ts';
import { isUndeliveredChangesRequested } from './review-producer-contract.ts';
import {
...
/**
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} runs
 ...
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} [allRuns]
 */
 ...
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} [options.allRuns]
 */
 ...
 * @param {{ evidenceByRunId?: Record<string, { artifact?: Record<string, unknown>, pointer?: Record<string, unknown> }>, allRuns?: import('./review-trigger-reconcile.ts').ReviewRun[] }} [options]
 */
...
/**
 * @param {import('./review-trigger-reconcile.ts').ReviewRun | null | undefined} run
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} reviewRuns
 * @param {number} prNumber
 * @param {string} headSha
...
runStdinJsonCli('autonomous-review-retry.ts', {
  enrichReviewRuns: () => {
