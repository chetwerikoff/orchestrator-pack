// @ts-nocheck
// Ported from docs/review-bulk-send-diagnose.mjs blob 3ec3fdf5f5200e85c7ae782fe70668b4e496511b; executable compatibility retained after AC7 terminalization.
/**
...
import { isDeliveredChangesRequested, isUndeliveredChangesRequested } from './review-producer-contract.ts';
...
runStdinJsonCli('review-bulk-send-diagnose.ts', {
  diagnose() {
