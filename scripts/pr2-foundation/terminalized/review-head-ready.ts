 ...
 *
 * @param {import('./review-trigger-reconcile.ts').AoSession | null | undefined} session
 */
...
/**
 * @param {object} input
 * @param {import('./review-trigger-reconcile.ts').AoSession} input.session
 * @param {string} input.headSha
 ...
 * @param {import('./review-trigger-reconcile.ts').AoSession[]} fresh.sessions
