// @ts-nocheck
// Ported from docs/review-head-ready.mjs blob 5376bb1423b978bf51ad43fa66542868684b1dc0; executable compatibility retained after AC7 terminalization.
/**
...
import { getReportState } from './review-finding-delivery-confirm.ts';
import {
  getSessionActivity,
  isDeliveryConsumed,
  isSessionStreaming,
...
} from './worker-message-dispatch-observe.ts';
import { parseLastActivityAgeMs } from '../../../docs/review-reconcile-primitives.mjs';
import {
...
import {
  ...
  toArray,
} from './review-trigger-reconcile.ts';
import { resolveFailureDetail } from './review-producer-contract.ts';
import { buildTimeoutRetryObserved } from '../../../docs/codex-reviewer-timeout-retry.mjs';
import { resolveFailedRunRetryEligibility } from './autonomous-review-retry.ts';
...
export { hasFailedOrCancelledOnHead } from './review-trigger-reconcile.ts';
 ...
 *
 * @param {import('./review-trigger-reconcile.ts').RuntimeWorker | null | undefined} session
 */
...
/**
 * @param {object} input
 * @param {import('./review-trigger-reconcile.ts').RuntimeWorker} input.session
 * @param {string} input.headSha
...
/**
 * @param {import('./review-trigger-reconcile.ts').OpenPr[] | import('./review-trigger-reconcile.ts').OpenPr} [openPrs]
 * @param {number} prNumber
 */
 ...
 * @param {object} fresh
 * @param {import('./review-trigger-reconcile.ts').OpenPr[]} [fresh.openPrs]
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} fresh.reviewRuns
 * @param {import('./review-trigger-reconcile.ts').RuntimeWorker[]} fresh.sessions
...
/**
 * @param {import('./review-trigger-reconcile.ts').ReviewRun | null} run
 * @param {number} prNumber
 * @param {string} headSha
 */
