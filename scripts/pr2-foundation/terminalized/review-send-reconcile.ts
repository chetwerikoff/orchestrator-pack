// @ts-nocheck
// Ported from docs/review-send-reconcile.mjs blob fc762e90c32f7516daa2bfb69f5d322c15ca321f; executable compatibility retained after AC7 terminalization.
/**
...
import { getReviewRunId } from './review-finding-delivery-confirm.ts';
import { shouldOrchestratorActOnRun } from '../../../docs/review-orchestrator-loop.mjs';
import { isRuntimeAlive } from '../../../docs/review-ready-stuck-guard.mjs';
import { resolveCurrentPrHeadSha } from './review-head-ready.ts';
import {
  findSessionById,
...
import { LEGACY_SENT_FINDING_COUNT_KEY } from '../../../docs/review-reconcile-primitives.mjs';
...
runStdinJsonCli('review-send-reconcile.ts', {
  plan: () => {
