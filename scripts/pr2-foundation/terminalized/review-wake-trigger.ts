// @ts-nocheck
// Ported from docs/review-wake-trigger.mjs blob dacd249808ea675c10bacaeef5259b5cc6a987ca; executable compatibility retained after AC7 terminalization.
/**
...
} from './review-producer-contract.ts';
import { nonEmptyString } from './orchestrator-wake-filter.ts';
import {
  buildReviewRunArgv,
...
import { evaluateWorkerIterationCycleForPr } from './worker-iteration-cycle.ts';
 ...
 * @param {import('./review-trigger-reconcile.ts').OpenPr[]} [input.openPrs]
 * @param {import('./review-trigger-reconcile.ts').ReviewRun[]} [input.reviewRuns]
 * @param {import('./review-trigger-reconcile.ts').RuntimeWorker[]} [input.sessions]
...
runStdinJsonCli('review-wake-trigger.ts', {
