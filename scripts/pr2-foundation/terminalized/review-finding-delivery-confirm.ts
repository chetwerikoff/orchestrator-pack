// @ts-nocheck
// Ported from docs/review-finding-delivery-confirm.mjs blob 4784cf00aa79be7e38b1d9dd898b4dd5644d7b60; executable compatibility retained after AC7 terminalization.
/**
...
export { resolvePrSessionBindingForConsumer } from '../../../docs/pr-session-binding-cache.mjs';
import {
...
} from './events-optional-consumer-signal-recovery.ts';
import {
  findPackWorkerAckReportAfterDelivery,
  PACK_WORKER_REPORT_STORE_SURFACE,
} from './worker-report-store.ts';
...
runStdinJsonCli('review-finding-delivery-confirm.ts', {
  plan: () => {
