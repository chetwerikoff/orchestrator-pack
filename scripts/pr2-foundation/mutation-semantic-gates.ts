...
const IMMUTABLE_BASE_SHA256: Readonly<Record<string, string>> = Object.freeze({
  ...
  'scripts/pack-review-runner.ts': 'ba84119e59b8f5255c7f1dad3e734d84f49d89a8db8704e4821ff806d8fa4b5e',
...
const GATES: Record<string, TextGate> = {
  ...
  'AC1:legacy-starter-disabled': baseGate('scripts/orchestrator-wake-supervisor.ts'),
  ...
  'AC9:cutover-path-modified': baseGate('scripts/orchestrator-wake-supervisor.ts'),
  'AC9:registry-or-supervisor-modified': baseGate('scripts/orchestrator-wake-supervisor.ts'),
