...
export const FOUNDATION_MUTATION_CATALOG: readonly MutationBinding[] = Object.freeze([
  ...entries('AC1', {
    ...
    'legacy-starter-disabled': 'scripts/orchestrator-wake-supervisor.ts',
  ...
  ...entries('AC9', {
    'modification-outside-independent-union': 'scripts/pr2-foundation/real-scope-proof.ts',
    'manifest-self-authorizes': 'scripts/pr2-foundation/contracts.ts',
    'cutover-path-modified': 'scripts/orchestrator-wake-supervisor.ts',
    'registry-or-supervisor-modified': 'scripts/orchestrator-wake-supervisor.ts',
    'declaration-snapshot-missing': 'scripts/pr2-foundation/real-scope-proof.ts',
    'declaration-created-after-implementation': 'scripts/pr2-foundation/real-scope-proof.ts',
