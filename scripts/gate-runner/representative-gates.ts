  ...
  rules: [
    {
      ...
      paths: [
        ...
        '.cursor/skills/adversarial-draft-review/SKILL.md',
      ...
      assertions: [
        {
          ...
          exactOccurrences: [
            ...
            { marker: '(.cursor/skills/merge-with-local-adoption/SKILL.md)', count: 1 },
            { marker: '(.cursor/skills/adversarial-draft-review/SKILL.md)', count: 1 },
