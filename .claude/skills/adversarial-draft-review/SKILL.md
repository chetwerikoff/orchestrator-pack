...
Read and execute [`.cursor/skills/adversarial-draft-review/SKILL.md`](../../../.cursor/skills/adversarial-draft-review/SKILL.md) in full. Do not re-derive the workflow inline.
